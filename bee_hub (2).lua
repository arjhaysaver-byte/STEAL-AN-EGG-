...
Title.TextSize = 18
Title.Text = "BEE HUB 🐝 | Steal an Egg"
...
currentShade2 = Color3.fromRGB(255, 255, 0)
currentShade3 = Color3.fromRGB(78, 78, 79)
currentText1 = Color3.fromRGB(255, 255, 0)
...
task.spawn(function()
    ...
    Circle.Name = "Circle"
    Circle.Parent = IntroGui
    Circle.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    Circle.BackgroundTransparency = 0
    Circle.BorderSizePixel = 5
    Circle.BorderColor3 = Color3.fromRGB(255, 255, 0)
    ...
    IntroText.Parent = Circle
    IntroText.BackgroundTransparency = 1
    IntroText.Size = UDim2.new(1, 0, 1, 0)
    IntroText.Font = Enum.Font.SourceSansBold
    IntroText.Text = "WELCOME TO BEE HUB 🐝🍯"
    IntroText.TextColor3 = Color3.fromRGB(255, 255, 0)
    IntroText.TextSize = 25
    IntroText.TextWrapped = true
    
    -- Fade and wait for 10s
    task.wait(10)
    
    local tween = TweenService:Create(Circle, TweenInfo.new(1), {Size = UDim2.new(0,0,0,0), Position = UDim2.new(0.5,0,0.5,0), BackgroundTransparency = 1})
    local textTween = TweenService:Create(IntroText, TweenInfo.new(1), {TextTransparency = 1})
    tween:Play()
    textTween:Play()
